...
enum fs_context_phase {
	...
	FS_CONTEXT_FAILED,		/* Context failed and cannot continue */
};
...
struct fs_context {
	...
	struct vfsmount		*root_mnt;	/* Specific mount for reconfigure */
...
extern int reconfigure_single(struct super_block *s, int flags, void *data);
...
#define __plog(p, l, fmt, ...) \
	logfc((p)->log, (p)->prefix, l, fmt, ## __VA_ARGS__)
